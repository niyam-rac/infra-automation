...
module "dataStorageAccountModules" {
  ...
  hierarchicalNamespaceEnabled    = var.dataStorageAccount.hierarchicalNamespaceEnabled
  sharedAccessKeyEnabled          = try(var.dataStorageAccount.sharedAccessKeyEnabled, false)
}
